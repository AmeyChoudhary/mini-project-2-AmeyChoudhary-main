...
main(int argc, char *argv[]) {
  ...
  6a:	7ea50513          	addi	a0,a0,2026 # 850 <malloc+0xf2>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 410:	46450513          	addi	a0,a0,1124 # 870 <digits>
 414:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4dc:	398b8b93          	addi	s7,s7,920 # 870 <digits>
 ...
 61c:	25090913          	addi	s2,s2,592 # 868 <malloc+0x10a>
        while(*s != 0){
